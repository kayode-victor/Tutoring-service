...
const Hero = () => {
  return (
    <div className="relative flex flex-col gap-5  md:flex-row w-full rounded-lg h-full justify-center items-center bg-background px-0 md:pl-5 lg:pl-10 my-10">
      ...
      <div className="relative flex flex-col lg:w-2/5 items-center h-[500px] w-[500px] rounded-full bg-primary">
        ...
        <img
          ...
          className="h-[440px] w-[440px] -bottom-16 -left-10 relative z-10"
        />
      </div>
    </div>
  );
